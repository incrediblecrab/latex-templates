...
Uncomment it to restore Palatino. This switches both text and math fonts; leave the encoding and language packages unchanged. No other font package or compilation engine is needed.
